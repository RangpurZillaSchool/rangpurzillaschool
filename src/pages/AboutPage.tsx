      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 space-y-6">
          ...
          <Reveal delay={200} direction="up">
            <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-xs space-y-3 card-organic">
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <Reveal delay={150} direction="up">
            <div className="bg-gradient-to-br from-institutional-navy to-institutional-navyDark text-white rounded-xl p-6 shadow-md space-y-4 card-organic group">
              <BookOpen className="w-8 h-8 text-amber-400 transition-transform group-hover:scale-110" />
              ...
              <Link
                to="/about/history"
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-md bg-amber-500 hover:bg-amber-400 text-amber-950 font-bold text-xs transition-all btn-shimmer"
              >
                <span>সম্পূর্ণ ইতিহাস পড়ুন</span> <ArrowRight className="w-3.5 h-3.5 transition-transform group-hover:translate-x-1" />
              </Link>
            </div>
          </Reveal>
          ...
          {/* Key contacts widget */}
          <Reveal delay={200} direction="up">
            <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-xs space-y-3 text-xs card-organic">
          ...
          <Reveal delay={250} direction="up">
            <div className="bg-amber-50/90 rounded-xl border border-amber-200/80 p-5 shadow-xs space-y-2 text-xs text-amber-950 card-organic">
              ...
              <div className="pt-1.5">
                <a
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-amber-600 hover:bg-amber-700 text-white font-medium text-xs transition-colors shadow-xs btn-shimmer"
                >
