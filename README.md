...
### 🌈 ৭. ১২টি কালার ও কন্ট্রাস্ট থিম (12 Built-in Themes)
ব্যবহারকারীর পছন্দ ও পাঠাভ্যাস অনুযায়ী টপবারে এক ক্লিকে ১২টি থিমে পরিবর্তন করার সুবিধা (স্বয়ংক্রিয়ভাবে লোকাল স্টোরেজে সংরক্ষিত থাকে):
1. **ক্লাসিক লাইট (Classic Light)**: ঐতিহ্যবাহী প্রাতিষ্ঠানিক নেভি ও গোল্ডেন থিম।
2. **মডার্ন ডার্ক (Modern Dark)**: ডিপ স্লেট ব্যাকগ্রাউন্ড ও সায়ান অ্যাকসেন্ট।
3. **সেপিয়া (Warm Sepia)**: দীর্ঘ সময় পড়ার জন্য চোখের আরামদায়ক উষ্ণ কাগজের আবহ।
4. **নর্ডিক কোল্ড ব্লু (Nord Frost)**: আর্কটিক স্নো-ব্লু ও শান্ত ধূসর টোন।
5. **সবুজ ক্যাম্পাস (Emerald Green)**: বিদ্যালয় মাঠ ও প্রকৃতির সতেজ সবুজ ভাব।
6. **গোধূলি অরেঞ্জ (Golden Sunset)**: উষ্ণ রক্তিম ও সোনালী আভা।
7. **সাইবার নিয়ন (Cyberpunk Neon)**: হাই-কনট্রাস্ট ইলেকট্রিক পিঙ্ক ও নিয়ন ব্লু।
8. **ড্রাকুলা পার্পল (Dracula Purple)**: ক্লাসিক ডার্ক ভায়োলেট ও পিঙ্ক প্যালেট।
9. **গভীর অরণ্য (Deep Forest)**: নৈশ বনানীর গাঢ় শান্ত সবুজ।
10. **মহাসাগর ব্লু (Deep Ocean)**: গভীর সাগরের নীলিমায় মোড়ানো আবহ।
